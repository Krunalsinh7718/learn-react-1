    ...
    <>
      <li
        className={`border p-3 mb-2 rounded-md  ${
          taskCompleted ? "bg-emerald-700" : "bg-cyan-950"
        }`}
      >
        <div className="flex justify-between items-center gap-5">
          <div className="flex gap-4 items-center">
            ...
            {todoEditable ? (
              ...
              <label
                htmlFor={chkId}
                className={`text-white ${taskCompleted ? "strike-text" : ""}`}
              >
                <span>{task}</span>
              </label>
            )}
          ...
          <div className="flex gap-2">
            <button
              className={`h-10 w-10 rounded-full bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black ${
                taskCompleted ? "disabled:opacity-25" : ""
              }`}
